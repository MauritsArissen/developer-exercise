...
public class ChartComponent extends Component {
    ...
    public void onLoad() {
        ...
        registerEvent(GetPlayerXp.class, this::onGetPlayerXp);
    }
    ...
    private void onGetPlayerXp(GetPlayerXp event) {
    	event.setXp(getStats(event.getPlayer()).getXp(event.getSkill()));
    }
